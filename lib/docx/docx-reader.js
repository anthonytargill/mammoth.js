...
function read(docxFile, input) {
    ...
    return promises.props({
        ...
        // CHANGE HERE - pulling out the full styles information
        return {
            stylesFull: readXmlFromZipFile(docxFile,  result.partPaths.styles)
        };
    }).also(function(result) {
        return {
        ...
        return {
            document: readXmlFileWithBody(result.partPaths.mainDocument, result, function(bodyReader, xml) {
        ...
        return {
            ...
            // CHANGE HERE - pulling out the full styles information and made the object have sub properties
            // document and styles
            styles: result.stylesFull
        }
    });
}
