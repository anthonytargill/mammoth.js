...
function BodyReader(options) {
        ...
        "w:p": function(element) {
            return readXmlElements(element.children)
                .map(function(children) {
                    ...
                    properties.hasLastRenderedPageBreak = 
                        element.children?.find(child => child.name==='w:r')?.
                            children?.find(child => child.name ==='w:lastRenderedPageBreak') ? true : null;
    ...
    function readTableCell(element) {
        return readXmlElements(element.children).map(function(children) {
            ...
            var backgroundColor = properties.firstOrEmpty("w:shd").attributes["w:fill"];
