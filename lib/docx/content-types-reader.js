...
// CHANGE HERE - have a function to return the styles and numbering
exports.readStylesAndNumbering = readStylesAndNumbering
...
// CHANGE HERE - have a function to return the styles and numbering
function readStylesAndNumbering(docxFile, input) {
    input = input || {};
    return promises.props({
        ...
        return {
            numbering: result.numbering.getNumbering(),
            styles: result.styles.getAllStyles()
        }
    });
}
