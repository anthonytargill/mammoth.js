...
function readAbstractNum(element) {
    ...
    element.getElementsByTagName("w:lvl").forEach(function(levelElement) {
        ...
        // CHANGE here, sometimes the indentation is specified in the numbering file
        // per level. In this case, pull it put and add it to the levels text
        var indentation = levelElement.firstOrEmpty('w:pPr').firstOrEmpty('w:ind').attributes["w:left"]
