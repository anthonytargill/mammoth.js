...
function Paragraph(children, properties) {
  ...
  return {
    ...
    // CHANGE HERE - cope with start, and left and end and right
    indent: {
      start: indent.start || indent.left || null,
      end: indent.end || indent.right || null,
...
function Run(children, properties) {
  ...
  return {
    ...
    //CHANGE HERE to surface the color
